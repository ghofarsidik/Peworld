...
import Navbarbl from "../components/base/Navbarbl.jsx"
            ...
            <div className="mx-auto max-w-[1140px]">
                <div className="flex flex-col space-y-12 mx-auto">
                    <div className="flex items-center mx-auto">
                        <div className="max-w-[692.175px] lg:w-1/2 ">
                            ...
                            <Link to="/login"> <button className="text-base text-white bg-ungu-pj p-[15px] rounded mt-[30px]">Mulai Dari Sekarang</button></Link>
                        </div>
                    ...
                    <div className="flex items-center mx-auto">
                        ...
                        <div className="flex flex-col space-y-5">
                            ...
                            <p className="flex"><img className="mr-3 w-6 h-6" src={Pcheck} alt="" />Lorem ipsum dolor sit amet.</p>
                            <p className="flex"><img className="mr-3 w-6 h-6" src={Pcheck} alt="" />Lorem ipsum dolor sit amet.</p>
                            <p className="flex"><img className="mr-3 w-6 h-6" src={Pcheck} alt="" />Lorem ipsum dolor sit amet.</p>
                            <p className="flex"><img className="mr-3 w-6 h-6" src={Pcheck} alt="" />Lorem ipsum dolor sit amet.</p>
                        </div>
                    ...
                    <div className="flex items-center mx-auto">
                        <div className="max-w-[692.175px] lg:w-1/2">
                            ...
                            <h2 className="text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In euismod ipsum et dui rhoncus auctor.</h2>
                ...
                <div className="flex flex-wrap justify-evenly mt-10">
                    <div className="shadow-lg hover:shadow-xl h-[437px] w-[339px] flex flex-col items-center p-8 text-center">
                        ...
                        <p className="font-Osans text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In euismod ipsum et dui rhoncus auctor.</p>
                    </div>
                    <div className="shadow-lg hover:shadow-xl h-[437px] w-[339px] flex flex-col items-center p-8 text-center">
                        ...
                        <p className="font-Osans text-lg text-abu-pj">Web developer</p>
                        <p className="font-Osans text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                    </div>
                    <div className="shadow-lg hover:shadow-xl h-[437px] w-[339px] flex flex-col items-center p-8 text-center">
                        ...
                        <p className="font-Osans text-lg text-abu-pj">Web developer</p>
                        <p className="font-Osans text-lg">Lorem ipsum dolor sit amet, consectetur </p>
                    </div>
                </div>
                ...
                <div className="bg-ungu-pj flex h-[227px] items-center justify-between px-[70px] rounded-lg rounded-tl-[40px] rounded-br-[40px] mt-14">
                    <p className="text-4xl font-semibold font-Osans text-white max-w-[293px]">Lorem ipsum dolor sit amet</p>
