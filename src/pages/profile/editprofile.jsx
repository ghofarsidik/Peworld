                ...
                <div className="w-full md:max-w-[754px] h-fit mx-auto">
                    <div className="w-full md:max-w-[754px] h-fit rounded bg-white flex flex-col p-[30px] mx-auto">
                        ...
                        <div className="flex flex-col">
                            <Input labelClassName="mt-0" label="Nama" name="name" onChange={handleChange} type="text" value={form.name} placeholder="Masukkan nama lengkap" />
                            <Input label="Job desk" name="job_desk" onChange={handleChange} type="text" value={form.job} placeholder="Masukkan job desk" />
                            <Input label="Domisili" name="domicile" onChange={handleChange} type="text" value={form.job_desk} placeholder="Masukkan domisili" />
                            <Input label="Tempat kerja" name="workplace" onChange={handleChange} type="text" value={form.workplace} placeholder="Masukkan tempat kerja" />
                    ...
                    <div className="w-full md:max-w-[754px] h-fit rounded bg-white flex flex-col p-[30px] mx-auto mt-8">
                        ...
                        <div className="flex items-center space-x-2">
                            <Input divClassName="flex-grow" labelClassName="mt-0" label="" name="skill" onChange="" type="text" value="" placeholder="Masukkan skill" />
                    ...
                    <div className="w-full md:max-w-[754px] h-fit rounded bg-white flex flex-col p-[30px] mx-auto mt-8">
                        ...
                        <div className="flex flex-col">
                            <Input labelClassName="mt-0" label="Posisi" name="position" onChange="" type="text" value="" placeholder="Masukkan posisi" />
                            <div className="flex flex-col sm:flex-row justify-between sm:space-x-4">
                                <Input divClassName="flex-1" label="Nama perusahaan" name="company" onChange="" type="text" value="" placeholder="Masukkan nama perusahaan" />
                                <Input divClassName="flex-1" label="Bulan/tahun" name="time" onChange="" type="text" value="" placeholder="Masukkan bulan dan tahun" />
                            </div>
                            <Input label="Deskripsi singkat" name="job_description" onChange="" type="text" value="" placeholder="Masukkan deskripsi pekerjaan anda" />
                            <Button label="Tambah pengalaman kerja" className="border-orange-pj border bg-white text-orange-pj"></Button>
                        </div>
                    ...
                    <div className="w-full md:max-w-[754px] h-fit rounded bg-white flex flex-col p-[30px] mx-auto mt-8">
                        ...
                        <div className="flex flex-col">
                            <Input labelClassName="mt-0" label="Nama aplikasi" name="application_name" onChange="" type="text" value="" placeholder="Masukkan nama aplikasi" />
                            <Input label="Link repository" name="link_repository" onChange="" type="text" value="" placeholder="Masukkan deskripsi pekerjaan anda" />
                            <Button label="Tambah pengalaman kerja" className="border-orange-pj border bg-white text-orange-pj"></Button>
                            ...
                            <img src={iupload} alt="" />
                            <Button label="Tambah portofolio" className="border-orange-pj border bg-white text-orange-pj"></Button>
